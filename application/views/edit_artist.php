...
<body>
    <div class = "container">
        ...
        <div class="square1">
            ...
            <p>
                <input type="file" id="avatar" name="pp" style="padding: 50px" accept="image/png, image/jpeg">
            ...
            <p>
                ...
                <p>
                <textarea type="textarea" style="resize:none;background-color:#e3e3e3;border:1px solid #ccc;margin-left:55px;border-radius:15px;padding: 10px 10px 10px 10px; " rows="15" cols="56" name="bio" ></textarea></p>
