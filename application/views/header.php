...
<head>
    ...
    <!-- (gunanya untuk buat jarak antar foto)
    <link rel="stylesheet" href="css/bootstrap.min.css">
    ================================================== -->

    <!-- Animate CSS (masih belum tau gunanya buat apa)
        <link rel="stylesheet" href="css/animate.min.css">
   ================================================== -->
	

    <!-- Font Icons CSS 
        (gunanya buat twiter facebook etc)
        <link rel="stylesheet" href="css/font-awesome.min.css">
        (gunanya buat strip 3 diatas)
   ...
   <link rel="stylesheet" href="<?php echo base_url();?>assets/CSS/style.css">
    ...
    <!-- Google web font (masih belum tau fungsinya di font yg mana)
...
<!-- Preloader section (masih belum tau fungsinya dimana)
    <div class="preloader">
...
<!-- Navigation section (ini udh ga perlu, soalnya kan kita gapake strip 3)
================================================== -->
        ...
        <div class="navbar">
          <div class="container">
             <div class="row">
               ...
               <div class="brand">
                 <a href="index.html" class="wow fadeIn" data-wow-delay="1.4s">VoteArt</a>
               </div>
...
<!-- Header section (ini mah bakal di ganti sama slide poto)
================================================== -->
...
<!-- Portfolio section (masih belum ngerti pengaturan data ttg data filternya)
================================================== -->
                              ...
                              <div class="iso-box-wrapper col4-iso-box">
                                 ...
                                 <div class="iso-box photoshop branding col-md-4 col-sm-6">
                                    <div class="portfolio-thumb">
                                       <img src="assets/foto/portfolio-img1.jpg" class="img-responsive" alt="Portfolio">
                                 ...
                                 <div class="iso-box graphic template col-md-4 col-sm-6">
                                    <div class="portfolio-thumb">
                                       <img src="assets/foto/portfolio-img2.jpg" class="img-responsive" alt="Portfolio">
                                          <div class="portfolio-overlay">
                                             <div class="portfolio-item">
                                                   <a href="single-project.html"><i class="fa fa-link"></i></a>
                                                   <h2>Project Two</h2>
                                 ...
                                 <div class="iso-box template graphic col-md-4 col-sm-6">
                                    <div class="portfolio-thumb">
                                       <img src="assets/foto/portfolio-img3.jpg" class="img-responsive" alt="Portfolio">
                                          <div class="portfolio-overlay">
                                             <div class="portfolio-item">
                                                   <a href="single-project.html"><i class="fa fa-link"></i></a>
                                                   <h2>Project Three</h2>
                                 ...
                                 <div class="iso-box graphic template col-md-4 col-sm-6">
                                    <div class="portfolio-thumb">
                                       <img src="assets/foto/portfolio-img4.jpg" class="img-responsive" alt="Portfolio">
                                          <div class="portfolio-overlay">
                                             <div class="portfolio-item">
                                                   <a href="single-project.html"><i class="fa fa-link"></i></a>
                                                   <h2>Project Four</h2>
                                 ...
                                 <div class="iso-box photoshop branding col-md-4 col-sm-6">
                                    <div class="portfolio-thumb">
                                       <img src="assets/foto/portfolio-img5.jpg" class="img-responsive" alt="Portfolio">
                                          <div class="portfolio-overlay">
                                             <div class="portfolio-item">
                                                   <a href="single-project.html"><i class="fa fa-link"></i></a>
                                                   <h2>Project Five</h2>
                                 ...
                                 <div class="iso-box graphic branding col-md-4 col-sm-6">
                                    <div class="portfolio-thumb">
                                       <img src="assets/foto/portfolio-img6.jpg" class="img-responsive" alt="Portfolio">
                                          <div class="portfolio-overlay">
                                             <div class="portfolio-item">
                                                   <a href="single-project.html"><i class="fa fa-link"></i></a>
                                                   <h2>Project Six</h2>
